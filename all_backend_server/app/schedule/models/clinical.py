...
from app.schedule.db import Base
from app.schedule.services.codes import calc_age
...
class Doctor(Base):
    ...
    # Reference to auth users.id — no cross-DB FK
...
class Prescription(Base):
    """Digital prescription written by a doctor for a patient visit."""
    ...
    notes: Mapped[str | None] = mapped_column(Text, nullable=True)
    prescribed_on: Mapped[date] = mapped_column(
